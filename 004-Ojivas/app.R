...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      column(width = 3,div(style="height:300px; overflow-y: scroll",tableOutput('tabla'))),
      column(width = 9,fluidRow(div(style="height:300px; overflow-y: scroll",tableOutput('tabla1'))),fluidRow(plotOutput('distPlot')))
    )
  )
)
