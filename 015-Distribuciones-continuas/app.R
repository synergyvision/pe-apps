    ...
    mainPanel(
      ...
      conditionalPanel(condition = "input.distribucion=='Exponencial'",tabsetPanel(type = "pills", id="pri2",tabPanel("Características",includeHTML("exponencial.html")),
                                                                                tabPanel('Cálculos',br(),br(),column(width=5,selectInput(inputId = 'exp',label = HTML('Seleccione el cálculo deseado'),choices = c('Función de densidad','Función de distribución','Cuantiles','Muestra aleatoria'),selected = NULL),
                                                                                          ...
                                                                                          conditionalPanel(condition = "input.exp=='Cuantiles'",
                                                                                                           ...
                                                                                                           numericInput(inputId = 'valorexp2',label = HTML('Seleccione la probabilidad correspondiente del cuantil'),min=0,max=1,step=0.1,value = 0.5,width = '150px')),
                                                                                          conditionalPanel(condition = "input.exp=='Muestra aleatoria'",
                                                                                                           ...
                                                                                                           numericInput(inputId = 'valorexp3',label = HTML('Seleccione el tamaño de la muestra deseada'),min=1,max=100,step=1,value = 10,width = '150px'))
                                                                                                                     ),
      ...
      conditionalPanel(condition = "input.distribucion=='Gamma'",tabsetPanel(type = "pills", id="pri3",tabPanel("Características",includeHTML("gamma.html")),
                                                                                  tabPanel('Cálculos',br(),br(),column(width=5,selectInput(inputId = 'gam',label = HTML('Seleccione el cálculo deseado'),choices = c('Función de densidad','Función de distribución','Cuantiles','Muestra aleatoria'),selected = NULL),
                                                                                            conditionalPanel(condition = "input.gam=='Función de densidad'",
                                                                                                             numericInput(inputId = 'alpha',label = HTML('Seleccione el valor del parámetro &alpha;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                                                             numericInput(inputId = 'beta',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                                            ...
                                                                                            conditionalPanel(condition = "input.gam=='Función de distribución'",
                                                                                                             numericInput(inputId = 'alpha1',label = HTML('Seleccione el valor del parámetro &alpha;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                                                             numericInput(inputId = 'beta1',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                                            ...
                                                                                            conditionalPanel(condition = "input.gam=='Cuantiles'",
                                                                                                             numericInput(inputId = 'alpha2',label = HTML('Seleccione el valor del parámetro &alpha;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                                                             numericInput(inputId = 'beta2',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                                                             numericInput(inputId = 'valorgamm2',label = HTML('Seleccione el valor de la probabilidad del cuantil'),min=0,max=1,step=0.1,value = 0.5,width = '150px')),
                                                                                            conditionalPanel(condition = "input.gam=='Muestra aleatoria'",
                                                                                                             numericInput(inputId = 'alpha3',label = HTML('Seleccione el valor del parámetro &alpha;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                                                             numericInput(inputId = 'beta3',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
      ...
      conditionalPanel(condition = "input.distribucion=='Chi-cuadrado'",tabsetPanel(type = "pills", id="pri5",tabPanel("Características",includeHTML('Chi-cuadrado.html')),
                                                                                   ...
                                                                                   conditionalPanel(condition = "input.chi=='Función de densidad'",
                                                                                                    numericInput(inputId = 'df',label = HTML('Seleccione los grados de libertad'),min=0,max=100,step=1,value = 3,width = '150px'),
                                                                                   ...
                                                                                   conditionalPanel(condition = "input.chi=='Función de distribución'",
                                                                                                    numericInput(inputId = 'df1',label = HTML('Seleccione los grados de libertad'),min=0,max=100,step=1,value = 3,width = '150px'),
                                                                                   ...
                                                                                   conditionalPanel(condition = "input.chi=='Cuantiles'",
                                                                                                    numericInput(inputId = 'df2',label = HTML('Seleccione los grados de libertad'),min=0,max=100,step=1,value = 3,width = '150px'),
                                                                                   ...
                                                                                   conditionalPanel(condition = "input.chi=='Muestra aleatoria'",
                                                                                                    numericInput(inputId = 'df3',label = HTML('Seleccione los grados de libertad'),min=0,max=100,step=1,value = 3,width = '150px'),
      ...
      conditionalPanel(condition = "input.distribucion=='Fisher-Snedecor'",tabsetPanel(type = "pills", id="pri6",tabPanel("Características",includeHTML('Fisher-snedcor.html')),
                                                                               ...
                                                                               conditionalPanel(condition = "input.fish=='Función de densidad'",
                                                                                                numericInput(inputId = 'dfisher1',label = HTML('Seleccione los grados de libertad <i>n<sub>1</sub></i>'),min=0,max=100,step=1,value = 5,width = '150px'),
                                                                                                numericInput(inputId = 'dfisher2',label = HTML('Seleccione los grados de libertad <i>n<sub>2</sub></i>'),min=0,max=100,step=1,value = 2,width = '150px'),
                                                                               ...
                                                                               conditionalPanel(condition = "input.fish=='Función de distribución'",
                                                                                                numericInput(inputId = 'dfisher3',label = HTML('Seleccione los grados de libertad <i>n<sub>1</sub></i>'),min=0,max=100,step=1,value = 5,width = '150px'),
                                                                                                numericInput(inputId = 'dfisher4',label = HTML('Seleccione los grados de libertad <i>n<sub>2</sub></i>'),min=0,max=100,step=1,value = 2,width = '150px'),
                                                                               ...
                                                                               conditionalPanel(condition = "input.fish=='Cuantiles'",
                                                                                                numericInput(inputId = 'dfisher5',label = HTML('Seleccione los grados de libertad <i>n<sub>1</sub></i>'),min=0,max=100,step=1,value = 5,width = '150px'),
                                                                                                numericInput(inputId = 'dfisher6',label = HTML('Seleccione los grados de libertad <i>n<sub>2</sub></i>'),min=0,max=100,step=1,value = 2,width = '150px'),
                                                                               ...
                                                                               conditionalPanel(condition = "input.fish=='Muestra aleatoria'",
                                                                                                numericInput(inputId = 'dfisher7',label = HTML('Seleccione los grados de libertad <i>n<sub>1</sub></i>'),min=0,max=100,step=1,value = 5,width = '150px'),
                                                                                                numericInput(inputId = 'dfisher8',label = HTML('Seleccione los grados de libertad <i>n<sub>2</sub></i>'),min=0,max=100,step=1,value = 2,width = '150px'),
      ...
      conditionalPanel(condition = "input.distribucion=='Weibull'",tabsetPanel(type = "pills", id="pri8",tabPanel("Características",includeHTML('Weibull.html')),
                                                                                         ...
                                                                                         conditionalPanel(condition = "input.wei=='Función de densidad'",
                                                                                                          ...
                                                                                                          numericInput(inputId = 'betaw',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 1.5,width = '150px'),
                                                                                         ...
                                                                                         conditionalPanel(condition = "input.wei=='Función de distribución'",
                                                                                                          ...
                                                                                                          numericInput(inputId = 'betaw1',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 1.5,width = '150px'),
                                                                                         ...
                                                                                         conditionalPanel(condition = "input.wei=='Cuantiles'",
                                                                                                          ...
                                                                                                          numericInput(inputId = 'betaw2',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 1.5,width = '150px'),
                                                                                         ...
                                                                                         conditionalPanel(condition = "input.wei=='Muestra aleatoria'",
                                                                                                          ...
                                                                                                          numericInput(inputId = 'betaw3',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 1.5,width = '150px'),
      ...
      conditionalPanel(condition = "input.distribucion=='Cauchy'",tabsetPanel(type = "pills", id="pri9",tabPanel("Características",includeHTML('Cauchy.html')),
                                                                              ...
                                                                              conditionalPanel(condition = "input.cau=='Función de densidad'",
                                                                                               numericInput(inputId = 'alphacau',label = HTML('Seleccione el valor del parámetro &alpha;'),min=-20,max=20,step=0.1,value = 0,width = '150px'),
                                                                                               numericInput(inputId = 'betacau',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                              ...
                                                                              conditionalPanel(condition = "input.cau=='Función de distribución'",
                                                                                               numericInput(inputId = 'alphacau1',label = HTML('Seleccione el valor del parámetro &alpha;'),min=-20,max=20,step=0.1,value = 0,width = '150px'),
                                                                                               numericInput(inputId = 'betacau1',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                              ...
                                                                              conditionalPanel(condition = "input.cau=='Cuantiles'",
                                                                                               numericInput(inputId = 'alphacau2',label = HTML('Seleccione el valor del parámetro &alpha;'),min=-20,max=20,step=0.1,value = 0,width = '150px'),
                                                                                               numericInput(inputId = 'betacau2',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
                                                                              ...
                                                                              conditionalPanel(condition = "input.cau=='Muestra aleatoria'",
                                                                                               numericInput(inputId = 'alphacau3',label = HTML('Seleccione el valor del parámetro &alpha;'),min=-20,max=20,step=0.1,value = 0,width = '150px'),
                                                                                               numericInput(inputId = 'betacau3',label = HTML('Seleccione el valor parámetro &beta;'),min=0.1,max=50,step=0.1,value = 2,width = '150px'),
